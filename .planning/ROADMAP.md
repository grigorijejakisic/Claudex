...
- [ ] **Phase 13: Organic Claudex** _(type: engineering)_ — Spec drafted 2026-05-14 at `.planning/research/2026-05-14-phase-13-organic-claudex.md`. Eliminates manual memory rituals (/starthere, /endsession) by making the autonomous substrate carry their weight. Six structural marks across 3 waves: (1) Sessions/ folder as per-turn-fsynced source-of-truth, (2) DB-as-derived-index recovery posture, (3) Angel highlights extraction (frame-aware distillation), (4) auto-orient at session-start + temporal awareness, (5) pull-trigger normalization for organic Claudex use, (6) delete /starthere and /endsession from .claude/skills/. Depends on Phase 12 (items 7, 8, 4 are prerequisites). v6.0.0 retag gets a TELEMETRY-BASED annotation at Phase 13 close-out (W3 empirical re-bind DEPRECATED 2026-05-14 — synthetic-probe ship gates judged less informative than real-use telemetry per Big Mozzy V2 diagnostic).
...
*Roadmap last updated: 2026-05-14 — Phase 12 SHIPPED (9/9, Vesna 29/29 at 100%, commit `357d0d5`). Phase 13 (Organic Claudex) drafted; /auto-orchestrate proceeding to discuss-13 → plan-13 → execute-13 → 13-CLOSE per operator's autonomous-mission directive (operator asleep). Phase 11 W3 empirical re-bind DEPRECATED 2026-05-14: synthetic-probe re-bind judged less informative than Phase 12 item 5 telemetry per Big Mozzy V2 diagnostic. v6.0.0 retag annotation will be telemetry-based at Phase 13 close-out, pending operator confirmation on wake.*
