...
**Current focus:** **v4.1 Distribution milestone kickoff (2026-04-30).** Locked decisions: license MIT, platforms Windows + Mac + Linux, harness Claude Code only, self-host only. Defining requirements next. v4.0 history preserved below in Accumulated Context.

## Current Position

**Current Milestone:** v4.1 — Distribution
**Phase:** Not started (defining v4.1 requirements)
**Plan:** —
**Status:** Defining v4.1 requirements
**Last activity:** 2026-04-30 — Milestone v4.1 started
