...
**Last activity:** 2026-05-15 — Phase 14 Wave 1 in progress. Plan 14-01 (handoff schema + migrator) COMPLETE. parseHandoffHeader telemetry-on-rejection shipped; migrate-handoff.ts CLI shipped; big-mozzy-v2 ACTIVE.md + ACTIVE-agent2.md migrated; 55 tests pass. Branch: phase-14/01-handoff-schema. Key decisions: handoff_parse_failed added to TELEMETRY_SCHEMA CHECK; created_at (ISO) is legacy not canonical; --phase required on ambiguous inference.
