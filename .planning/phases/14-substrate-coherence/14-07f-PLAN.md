...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/assembly/sections/links.ts"
      provides: "Adds formatPendingReviewLinksSection function. Wave 0 w0d created this file as a placeholder; F populates it. Owns ONLY this new function per WAVE2-COORDINATION."
      contains: "formatPendingReviewLinksSection"
    - path: "src/assembly/sections/index.ts"
      provides: "Adds re-export of formatPendingReviewLinksSection so callers of assembly/sections.js still work unchanged."
      contains: "formatPendingReviewLinksSection"
