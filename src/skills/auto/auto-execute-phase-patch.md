...
**Status:** APPLIED 2026-05-15 — patch content appended to `~/.claude/skills/auto-execute-phase/SKILL.md` as a clearly-labeled "Operator-applied patch" section at the end of the file. Reversible by deleting that section. Tomorrow tests whether the appended rules are picked up at skill-invocation time.
